              ...
              <div>
                ...
                <div className="relative flex w-full flex-col items-start justify-between gap-3">
                  <div className="flex h-[38px] w-full pt-1.5">
                    <div className="flex h-1.5 w-full items-center rounded-full bg-subtle-gray dark:bg-rich-brown/50 relative">
                      <div className="absolute left-0 top-0 h-full rounded-full bg-primary" style={{ width: `${((priceRange[1] - priceRange[0]) / 60) * 100}%`, left: `${((priceRange[0] - 15) / 60) * 100}%` }}></div>
                      <div className="absolute -left-2 -top-2 flex flex-col items-center gap-1.5 cursor-pointer" style={{ left: `${((priceRange[0] - 15) / 60) * 100}%` }}>
                      ...
                      <div className="absolute -right-2 -top-2 flex flex-col items-center gap-1.5 cursor-pointer" style={{ right: `${((75 - priceRange[1]) / 60) * 100}%` }}>
                        <div className="size-4 rounded-full bg-rich-brown dark:bg-cream ring-2 ring-white dark:ring-background-dark"></div>
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div>
                    ...
                    <div className="relative flex w-full flex-col items-start justify-between gap-3">
                      ...
                      <div className="flex justify-between w-full text-sm text-text-muted-light dark:text-text-muted-dark">
